...
class game:
    ...
    def Game():
        ...
        t = Label(top , text="Welcome To Level Six"
        ...
        #command
        def bW():
            CheckAnswerE.WrongAnswer("L6") 
        def bR():
            CheckAnswerE.RightAnswer("L6")
    ...
    def nextQ1():
        ...
        #command
        def bW():
            CheckAnswerE.WrongAnswer2("L6") 
        def bR():
            CheckAnswerE.RightAnswer2("L6")
        #create the choose button
        btn1 = Button(fr2, image= photo5,width=250,height=150 
                        ,relief = GROOVE ,bg="#98f5ff", borderwidth=2,command= bW)
        btn1.pack(pady=50,side= LEFT)
    ...
    def nextQ2():
        ...
        #command
        def bW():
            CheckAnswerE.WrongAnswer3("L6") 
        def bR():
            CheckAnswerE.RightAnswer3("L6")
        #create the choose button
        btn1 = Button(fr2, image= photo5,width=250,height=150 
                        ,relief = GROOVE ,bg="#98f5ff", borderwidth=2,command= bW)
        btn1.pack(pady=50,side= LEFT)
    ...
    def nextQ3():
        ...
        #command
        def bW():
            CheckAnswerE.WrongAnswer4("L6") 
        def bR():
            CheckAnswerE.RightAnswer4("L6")
        #create the choose button
        btn1 = Button(fr2, image= photo5,width=250,height=150 
                        ,relief = GROOVE ,bg="#98f5ff", borderwidth=2,command= bW)
        btn1.pack(pady=50,side= LEFT)
    ...
    def nextQ4():
        ...
        #command
        def bW():
            CheckAnswerE.WrongAnswer5("L6") 
        def bR():
            CheckAnswerE.RightAnswer5("L6")
        #create the choose button
        btn1 = Button(fr2, image= photo5,width=250,height=150 
                        ,relief = GROOVE ,bg="#98f5ff", borderwidth=2,command= bW)
        btn1.pack(pady=50,side= LEFT)
