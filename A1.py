...
class game:
    ...
    def Game():
        ...
        t = Label(fr2 , text="مرحباً بك في المستوى الأول",font=("Calibri",22,BOLD),fg="#4c2b50",bg="#c9a0dc")
        ...
        def bW():
            CheckAnswerA.WrongAnswer("A1") 
        def bR():
            CheckAnswerA.RightAnswer("A1")
    ...
    def nextQ1():
        ...
        def bW():
            CheckAnswerA.WrongAnswer2("A1") 
        def bR():
            CheckAnswerA.RightAnswer2("A1")
        #create the choose button
    ...
    def nextQ2():
        ...
        q1 = Label(fr3, text= "مرحباً بك في المستوى الأول"
                    ,font=("Calibri",22,BOLD),fg="#4c2b50",bg="#ff8b00")
        q1.pack(fill=X , pady=30)

        def bW():
            CheckAnswerA.WrongAnswer3("A1") 
        def bR():
            CheckAnswerA.RightAnswer3("A1")
        #create the choose button
    ...
    def nextQ3():
        ...
        def bW():
            CheckAnswerA.WrongAnswer4("A1") 
        def bR():
            CheckAnswerA.RightAnswer4("A1")
        #create the choose button
        btn1 = Button(fr2, text= "bags",width=12,height=1,font=("Calibri",14,BOLD)
                        ,relief = GROOVE ,bg="#ff8b00",fg="white", borderwidth=2,command= bW)
        btn1.pack()
    ...
    def nextQ4():
        ...
        def bW():
            CheckAnswerA.WrongAnswer5("A1") 
        def bR():
            CheckAnswerA.RightAnswer5("A1")
        #create the choose button
