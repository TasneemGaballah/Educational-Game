...
class game:
    ...
    def Game():
        ...
        fr2.pack(pady=20)
        t = Label(fr2 , text="مرحباً بك في المستوى الخامس",font=("Calibri",22,BOLD),fg="#4c2b50",bg="#c9a0dc")
        ...
        p2.pack(pady=20)
        def bW():
            CheckAnswerA.WrongAnswer("A5") 
        def bR():
            CheckAnswerA.RightAnswer("A5")
    ...
    def nextQ1():
        ...
        p2.pack()
        def bW():
            CheckAnswerA.WrongAnswer2("A5") 
        def bR():
            CheckAnswerA.RightAnswer2("A5")
        #create the choose button
    ...
    def nextQ2():
        ...
        p2.pack()
        def bW():
            CheckAnswerA.WrongAnswer3("A5") 
        def bR():
            CheckAnswerA.RightAnswer3("A5")
        #create the choose button
    ...
    def nextQ3():
        ...
        p2.pack()
        def bW():
            CheckAnswerA.WrongAnswer4("A5") 
        def bR():
            CheckAnswerA.RightAnswer4("A5")
        #create the choose button
        btn1 = Button(fr2, text= "bags",width=12,height=1,font=("Calibri",14,BOLD)
                        ,relief = GROOVE ,bg="#ff8b00",fg="white", borderwidth=2,command= bW)
        btn1.pack()
    ...
    def nextQ4():
        ...
        p2.pack()
        def bW():
            CheckAnswerA.WrongAnswer5("A5") 
        def bR():
            CheckAnswerA.RightAnswer5("A5")
        #create the choose button
