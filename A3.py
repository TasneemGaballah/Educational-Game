...
class game:
    ...
    def Game():
        ...
        fr2.pack(pady=20)
        t = Label(fr2 , text="مرحباً بك في المستوى الثالث",font=("Calibri",22,BOLD),fg="#4c2b50",bg="#c9a0dc")
        ...
        def bW():
            CheckAnswerA.WrongAnswer("A3") 
        def bR():
            CheckAnswerA.RightAnswer("A3")
    ...
    def nextQ1():
        ...
        def bW():
            CheckAnswerA.WrongAnswer2("A3") 
        def bR():
            CheckAnswerA.RightAnswer2("A3")
        #create the choose button
    ...
    def nextQ2():
        ...
        def bW():
            CheckAnswerA.WrongAnswer3("A3") 
        def bR():
            CheckAnswerA.RightAnswer3("A3")
        #create the choose button
    ...
    def nextQ3():
        ...
        def bW():
            CheckAnswerA.WrongAnswer4("A3") 
        def bR():
            CheckAnswerA.RightAnswer4("A3")
        #create the choose button
        btn1 = Button(fr2, text= "bags",width=12,height=1,font=("Calibri",14,BOLD)
                        ,relief = GROOVE ,bg="#ff8b00",fg="white", borderwidth=2,command= bW)
        btn1.pack()
    ...
    def nextQ4():
        ...
        def bW():
            CheckAnswerA.WrongAnswer5("A3") 
        def bR():
            CheckAnswerA.RightAnswer5("A3")
        #create the choose button
