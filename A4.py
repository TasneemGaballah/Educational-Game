...
class game:
    ...
    def Game():
        ...
        fr2.pack(pady=20)
        t = Label(fr2 , text="مرحباً بك في المستوى الرابع",font=("Calibri",22,BOLD),fg="#4c2b50",bg="#c9a0dc")
        ...
        p2.pack(pady=20)
        def bW():
            CheckAnswerA.WrongAnswer("A4") 
        def bR():
            CheckAnswerA.RightAnswer("A4")
    ...
    def nextQ1():
        ...
        fr2.pack(pady=20)
        #image
        photo = PhotoImage(file="P\\glasses.png")
        photo.configure(height=365 , width= 345)
        #photoimage = photo.subsample(2, 2)
        p2=Label(fr2, image=photo)
        p2.pack()
        def bW():
            CheckAnswerA.WrongAnswer2("A4") 
        def bR():
            CheckAnswerA.RightAnswer2("A4")
        #create the choose button
    ...
    def nextQ2():
        ...
        fr3.pack(pady=20)
        #image
        photo = PhotoImage(file="P\\baby.png")
        photo.configure(height=365 , width= 345)
        #photoimage = photo.subsample(2, 2)
        p2=Label(fr3, image=photo)
        p2.pack()
        def bW():
            CheckAnswerA.WrongAnswer3("A4") 
        def bR():
            CheckAnswerA.RightAnswer3("A4")
        #create the choose button
    ...
    def nextQ3():
        ...
        fr2.pack(pady=20)
        #image
        photo = PhotoImage(file="P\\eyes.png")
        photo.configure(height=365 , width= 345)
        #photoimage = photo.subsample(2, 2)
        p2=Label(fr2, image=photo)
        p2.pack()
        def bW():
            CheckAnswerA.WrongAnswer4("A4") 
        def bR():
            CheckAnswerA.RightAnswer4("A4")
        #create the choose button
        btn1 = Button(fr2, text= "bags",width=12,height=1,font=("Calibri",14,BOLD)
                        ,relief = GROOVE ,bg="#ff8b00",fg="white", borderwidth=2,command= bW)
        btn1.pack()
    ...
    def nextQ4():
        ...
        p2.pack()
        def bW():
            CheckAnswerA.WrongAnswer5("A4") 
        def bR():
            CheckAnswerA.RightAnswer5("A4")
        #create the choose button
