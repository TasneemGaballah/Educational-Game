...
class game:
    ...
    def Game():
        ...
        t = Label(top , text="Welcome To Level Four"
        ...
        #image
        photo5 = PhotoImage(file ='P\\baby.png') #########
        photo6 = PhotoImage(file='P\\black.png')
        photo7 = PhotoImage(file='P\\baby.png')
        photo8 = PhotoImage(file='P\\baby.png')
        #command
        def bW():
            CheckAnswerE.WrongAnswer("L4") 
        def bR():
            CheckAnswerE.RightAnswer("L4")
    ...
    def nextQ1():
        ...
        #command
        def bW():
            CheckAnswerE.WrongAnswer2("L4") 
        def bR():
            CheckAnswerE.RightAnswer2("L4")
        #create the choose button
        btn1 = Button(fr2, image= photo5,width=250,height=150 
                        ,relief = GROOVE ,bg="#98f5ff", borderwidth=2,command= bW)
        btn1.pack(pady=50,side= LEFT)
    ...
    def nextQ2():
        ...
        #command
        def bW():
            CheckAnswerE.WrongAnswer3("L4") 
        def bR():
            CheckAnswerE.RightAnswer3("L4")
        #create the choose button
        btn1 = Button(fr2, image= photo5,width=250,height=150 
                        ,relief = GROOVE ,bg="#98f5ff", borderwidth=2,command= bW)
        btn1.pack(pady=50,side= LEFT)
    ...
    def nextQ3():
        ...
        #command
        def bW():
            CheckAnswerE.WrongAnswer4("L4") 
        def bR():
            CheckAnswerE.RightAnswer4("L4")
        #create the choose button
        btn1 = Button(fr2, image= photo5,width=250,height=150 
                        ,relief = GROOVE ,bg="#98f5ff", borderwidth=2,command= bW)
        btn1.pack(pady=50,side= LEFT)
        ...
        btn = Button(fr2, text= "Next Level",width=12,height=1,font=("Comic Sans MS",14,BOLD) 
                        ,relief = GROOVE ,bg="#4c3946",fg="white", borderwidth=2,command= level1.game.Game)
    ...
    def nextQ4():
        ...
        #command
        def bW():
            CheckAnswerE.WrongAnswer5("L4") 
        def bR():
            CheckAnswerE.RightAnswer5("L4")
        #create the choose button
        btn1 = Button(fr2, image= photo5,width=250,height=150 
                        ,relief = GROOVE ,bg="#98f5ff", borderwidth=2,command= bW)
        btn1.pack(pady=50,side= LEFT)
